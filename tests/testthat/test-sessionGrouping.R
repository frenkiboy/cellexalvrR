...
ofiles = c('2_paritalLog.Rmd', 'png/User.group.1.DDRtree.1_2.png', 'png/a_simple_figure.png','png/User.group.1.DDRtree.2_3.png' )
...
ofile=  file.path( datadir, '2_sessionGroupingTest.html')
